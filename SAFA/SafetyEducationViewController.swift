//
//  SafetyEducationViewController.swift
//  SAFA
//
...
final class SafetyEducationViewController: UIViewController {
    private lazy var riskTextLabel = UILabel().then {
        $0.font = UIFont(name: "AppleSDGothicNeo-SemiBold", size: 16)
        $0.text = "안전 교육 정보 카테고리"
...
extension SafetyEducationViewController: UITableViewDelegate, UITableViewDataSource {
