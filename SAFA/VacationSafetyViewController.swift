//
//  VacationSafetyViewController.swift
//  SAFA
//
...
final class VacationSafetyViewController: UIViewController {
    private lazy var riskTextLabel = UILabel().then {
        $0.font = UIFont(name: "AppleSDGothicNeo-SemiBold", size: 16)
        $0.text = "휴가 안전 정보 카테고리"
    ...
    private let safetyAccidentArray = ["익사","교통","음주","품위유지","자살"]
...
extension VacationSafetyViewController: UITableViewDelegate, UITableViewDataSource {
